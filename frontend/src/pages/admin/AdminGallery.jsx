    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold" style={{ color: '#8B6F8E' }}>{t('gallery.title')}</h1>
        ...
        <Tabs defaultValue="gallery" className="w-full">
          <TabsList className="grid w-full grid-cols-3 max-w-2xl">
            <TabsTrigger value="gallery" data-testid="gallery-tab">{t('gallery.galleryTab')}</TabsTrigger>
            <TabsTrigger value="styles" data-testid="styles-tab">{t('gallery.stylesTab')}</TabsTrigger>
            <TabsTrigger value="colors" data-testid="colors-tab">{t('gallery.colorsTab')}</TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {items.map((item) => (
                <div key={item.id} className="bg-white rounded-lg shadow overflow-hidden group relative">
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-sm font-semibold text-gray-900">{item.title_de}</h3>
                    <p className="text-xs text-gray-600 mt-1">{item.artist_name}</p>
                    <p className="text-xs text-gray-500 mt-1">{getLocalizedStyleName(item.style)}</p>
          ...
          <TabsContent value="styles" className="mt-6">
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">{t('gallery.stylesTitle')}</h2>
                  <p className="text-sm text-gray-500 mt-1">{t('gallery.stylesSubtitle')}</p>
                </div>
                <Button
          ...
          <TabsContent value="colors" className="mt-6">
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">{t('gallery.colorsTitle')}</h2>
                  <p className="text-sm text-gray-500 mt-1">{t('gallery.colorsSubtitle')}</p>
                </div>
                <Button
