        ...
        <div className="space-y-4">
          {messages.length === 0 ? (
            ...
            messages.map((message) => (
              <div key={message.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 gap-3 sm:gap-0">
                  <div className="flex-1">
                    <h3 className="font-bold text-base md:text-lg mb-2">{message.name}</h3>
                ...
                <div className="bg-gray-50 rounded-lg p-3 md:p-4">
                  <p className="text-sm md:text-base text-gray-700 whitespace-pre-wrap break-words">{message.message}</p>
                </div>
              </div>
            ))
          )}
