...
const AdminSidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex w-64 bg-white border-r border-gray-200 min-h-screen flex-col fixed left-0 top-0 overflow-y-auto">
      ...
      <div 
        className={`lg:hidden fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 z-30 transform transition-transform duration-300 ease-in-out overflow-y-auto ${
